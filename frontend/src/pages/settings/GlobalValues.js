...
import GloabalAddEditModel from "../../Models/GloabalAddEditModel";
...
function GlobalValues() {
  ...
  const { list, fetchStatus } = useSelector((store) => store.global);
                  ...
                  {list?.map((item, idx) => {
                    return (
                      <tr key={idx}>
                        ...
                        <td className="text-capitalize">{item.g_value}</td>
